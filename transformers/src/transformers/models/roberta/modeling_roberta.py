...
# Copied from transformers.models.bert.modeling_bert.BertNormOutput with Bert->Roberta
class RobertaNormOutput(nn.Module): # This class is added by Goro Kobayashi
    def __init__(self, config):
        super().__init__()
        self.num_attention_heads = config.num_attention_heads
        self.attention_head_size = int(config.hidden_size / config.num_attention_heads)
...
class RobertaAttention(nn.Module):
    def __init__(self, config):
        ...
        self.norm = RobertaNormOutput(config)  # added by Goro Kobayashi
